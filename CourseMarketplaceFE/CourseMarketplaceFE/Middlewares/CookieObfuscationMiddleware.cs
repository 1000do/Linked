...
namespace CourseMarketplaceFE.Middlewares
{
    public class CookieObfuscationMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly IDataProtector _protector;
        private const string ObfuscatedCookieName = "LinkedLearn.FE.Identity";
        
        // List of cookie names we want to hide
        private readonly string[] _targetCookies = new[] 
        { 
            "AccessToken", "RefreshToken", "UserName", "AvatarUrl", 
            "UserRole", "UserId", "IsVerified", "InstructorApprovalStatus" 
        };
