...
- **Test requirement:** Verify the functionality and validation rules of AddMaterialToLessonAsync.

| Category | Sub-category | Detail 1 | Detail 2 | UTCID01 | UTCID02 | UTCID03 |
| :--- | :--- | :--- | :--- | :---: | :---: | :---: |
| **Condition** | **Precondition** |  |  |  |  |  |
|  |  | Lesson not found |  | O |  |  |
|  |  | Unlinked Stripe limit reached |  |  | O |  |
|  |  | Valid request |  |  |  | O |
| **Confirm** | **Return** |  |  |  |  |  |
|  |  | Returns MaterialResponse |  |  |  | O |
|  | **Exception** |  |  |  |  |  |
|  |  | Exception: Lesson not found |  | O |  |  |
|  |  | BadRequestException: unlinked Stripe limit |  |  | O |  |
...
- **Test requirement:** Verify the functionality and validation rules of RestoreMaterialAsync.
...
|  |  | Task Completes |  |  |  | O |
|  | **Exception** |  |  |  |  |  |
|  |  | Exception: Material not found |  | O |  |  |
|  |  | Exception: Lesson not found |  |  | O |  |
| **Result** | **Type(N : Normal, A : Abnormal, B : Boundary)** |  |  | A | A | N |
|  | **Passed/Failed** |  | P | P | P | P |
|  | **Executed Date** |  |  | 10/08/2026 | 10/08/2026 | 10/08/2026 |
...
- **Test requirement:** Verify the functionality and validation rules of PermanentDeleteMaterialAsync.

| Category | Sub-category | Detail 1 | Detail 2 | UTCID01 | UTCID02 | UTCID03 | UTCID04 |
| :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| **Condition** | **Precondition** |  |  |  |  |  |  |
|  |  | Material not found |  | O |  |  |  |
|  |  | Unauthorized (Not in trash) |  |  | O |  |  |
|  |  | Lesson not found |  |  |  | O |  |
|  |  | Valid request |  |  |  |  | O |
| **Confirm** | **Return** |  |  |  |  |  |  |
|  |  | Task Completes |  |  |  |  | O |
